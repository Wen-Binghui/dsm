...
GlobalCalibration::GlobalCalibration()
    : levels_(0), pixelAngle_x(0.f), pixelAngle_y(0.f), pixelAngle_(0.f) {}
...
void GlobalCalibration::setCalibration(const int32_t width,
    ...
    for (int32_t level = 1; level < this->levels_; ++level) {
        ...
        this->K_[level] << fx, 0.f, cx, 0.f, fy, cy, 0.f, 0.f, 1.f;
...
int32_t GlobalCalibration::levels() const { return this->levels_; }
...
float GlobalCalibration::pixelAngleX() const { return this->pixelAngle_x; }

float GlobalCalibration::pixelAngleY() const { return this->pixelAngle_y; }

float GlobalCalibration::pixelAngle() const { return this->pixelAngle_; }
}  // namespace dsm