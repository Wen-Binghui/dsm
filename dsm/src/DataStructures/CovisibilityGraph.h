...
class CovisibilityGraph {
   public:
    ...
    void connect(const std::shared_ptr<Frame>& frame1,
                 const std::shared_ptr<Frame>& frame2, int weight);
    void disconnect(const std::shared_ptr<Frame>& frame1,
                    const std::shared_ptr<Frame>& frame2);

    void getAllConnections(const std::shared_ptr<Frame>& frame,
